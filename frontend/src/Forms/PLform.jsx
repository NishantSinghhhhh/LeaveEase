            ...
            <form>
              <Stack spacing={4}>
                <FormControl isRequired>
                  ...
                  <Input placeholder='Your Name' className={styles['chakra-input']} />
                </FormControl>

                <FormControl isRequired>
                  <FormLabel>Class</FormLabel>
                  <Input placeholder='Class' className={styles['chakra-input']} />
                </FormControl>

                <FormControl isRequired>
                  <FormLabel>Roll Number</FormLabel>
                  <Input placeholder='Roll Number' className={styles['chakra-input']} />
                </FormControl>

                <FormControl isRequired>
                  <FormLabel>Number of Classes Missed</FormLabel>
                  <Input type='number' placeholder='Number of Classes Missed' className={styles['chakra-input']} />
                </FormControl>

                <FormControl isRequired>
                  <FormLabel>Reason for Absence</FormLabel>
                  <Textarea placeholder='Reason for Absence' className={styles['chakra-input']} />
                </FormControl>
